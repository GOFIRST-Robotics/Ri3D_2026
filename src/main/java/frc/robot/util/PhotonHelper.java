...
public class PhotonHelper {
    static final PhotonCamera camera = new PhotonCamera("photonvision");
    ...
    static Optional<EstimatedRobotPose> getCameraFieldPos() { return poseEstimator.update(camera.getLatestResult()); }
}